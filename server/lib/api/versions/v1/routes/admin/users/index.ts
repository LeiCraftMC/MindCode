...
router.get('/',
    ...
    APIRouteSpec.authenticated({
        summary: "List users",
        description: "Retrieve MindCode accounts with optional role and search filters.",
...
router.post('/',
    ...
    APIRouteSpec.authenticated({
        summary: "Create user",
        description: "Provision a new MindCode account with the desired role.",
        tags: [DOCS_TAGS.ADMIN_USERS],
...
router.get('/:userId',
    ...
    APIRouteSpec.authenticated({
        summary: "Get user",
        description: "Retrieve details for a specific MindCode account.",
        tags: [DOCS_TAGS.ADMIN_USERS],
...
router.put('/:userId',
    ...
    APIRouteSpec.authenticated({
        summary: "Update user",
        description: "Modify profile fields or role for a MindCode account.",
        tags: [DOCS_TAGS.ADMIN_USERS],
...
router.put('/:userId/password',
    ...
    APIRouteSpec.authenticated({
        ...
        description: "Set a new password for a MindCode account and revoke active sessions.",
        tags: [DOCS_TAGS.ADMIN_USERS],
...
router.delete('/:userId',
    ...
    APIRouteSpec.authenticated({
        summary: "Delete user",
        description: "Permanently remove a MindCode account.",
        tags: [DOCS_TAGS.ADMIN_USERS],
